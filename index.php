...
<head>
        ...
        <title>Encode Online Judge</title>
        ...
        <link rel="icon" type="image/png" href="img/encode_logo.png">
...
<div class="main">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top nbar">
    <div class="navbar-header">
      <img class="navbar-brand" margin-left="100px" src="img/encode_logo.png" alt="Encode Logo" style="width:100px;height:73px;">
      <a class="navbar-brand lspace" href="home.php">Encode Online Judge</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="space"><a href="compiler.php"><i class="fa fa-code ispace"></i>Compiler</a></li>
      <li class="space"><a href="archive.php"><i class="fa fa-archive ispace"></i>Problem Archive</a></li>
      <li class="space"><a href="https://clist.by/"><i class="fa fa-cogs ispace"></i>Contests</a></li>
      <li class="space"><a href="https://www.stopstalk.com/"><i class="fa fa-cogs ispace"></i>StopStalk</a></li>
    </ul>
...
<b>Developed By Priyansh Saxena</b>
